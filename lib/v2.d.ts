...
export interface paths {
  "/api/v2/extra/stats/trade-volume": {
    /**
  ...
  "/api/v2/{worldDcRegion}/{itemIds}": {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["CurrentlyShownMultiViewV2"];
            "application/json": components["schemas"]["CurrentlyShownMultiViewV2"];
            "text/json": components["schemas"]["CurrentlyShownMultiViewV2"];
          };
        };
  ...
  "/api/v2/history/{worldDcRegion}/{itemIds}": {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["HistoryMultiViewV2"];
            "application/json": components["schemas"]["HistoryMultiViewV2"];
            "text/json": components["schemas"]["HistoryMultiViewV2"];
          };
        };
        /**
         * @description The world/DC or item requested is invalid. When requesting multiple items at once, an invalid item ID
...
export interface components {
  schemas: {
    ...
    CurrentlyShownMultiViewV2: {
      ...
      items?: ({
        [key: string]: components["schemas"]["CurrentlyShownView"] | undefined;
      }) | null;
      /**
       * Format: int32 
    ...
    HistoryMultiViewV2: {
      ...
      /** @description The item data that was requested, keyed on the item ID. */
      items?: ({
        [key: string]: components["schemas"]["HistoryView"] | undefined;
      }) | null;
      /**
       * Format: int32 
       * @description The ID of the world requested, if applicable.
